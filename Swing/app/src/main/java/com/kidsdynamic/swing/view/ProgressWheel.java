...
public class ProgressWheel extends View {
    ...
    private void setupPaints() {
        ...
        contourPaint.setFlags(Paint.ANTI_ALIAS_FLAG);
    }
    ...
    private void parseAttributes(TypedArray a) {
        ...
        int textStyle = a.getInt(R.styleable.ProgressWheel_pwTextStyle, 0);
        if (textStyle == 1) {
    ...
    private void scheduleRedraw() {
        ...
        if (null != onProgressListener) {
            onProgressListener.onProgress(repeatCount, progress);
        }
    ...
    public interface OnProgressListener {
        void onProgress(int repeatCount, float progress);
    }
